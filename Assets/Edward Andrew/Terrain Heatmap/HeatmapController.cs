...
namespace TerrainHeatmap
{
    ...
    public class HeatmapController : MonoBehaviour
    {
        ...
        #if UNITY_EDITOR
        [MenuItem("Tools/Edward Andrew/Terrain Heatmaps/Create New Terrain Heatmap")]
        ...
        [MenuItem("Tools/Edward Andrew/Terrain Heatmaps/Add Custom Heatmap Node to Selected GameObjects")]
    ...
    public class HeatmapControllerCustomInspector : Editor
    {
        ...
        void SelectHeatmapButtons()
        {
            ...
            if (GUI.changed)
            {
                EAUnityLib.Generic.BoundedType<int> boundHeatmapIndex = new EAUnityLib.Generic.BoundedType<int>(_heatmapController.SelectedHeatmapIndex, 0, _heatmapController.HeatmapCount - 1);
        ...
        void DisplayHeatmapResolution()
        {
            ...
            if (resolutionUpdated)
            {
                ...
                EAUnityLib.Generic.BoundedType<int> boundHeatmapResolution = new EAUnityLib.Generic.BoundedType<int>(_heatmapController.SelectedHeatmap.heatmapResolution, 1, _heatmapController.AlphaMapResolution);
